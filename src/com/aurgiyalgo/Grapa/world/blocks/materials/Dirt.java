...
public class Dirt extends Block {
	...
	public void createModel(ModelBuilder modelBuilder, int x, int y, int z, int[][][] data, Chunk chunk) {
		...
		int chunkX = chunk.getGridPosition().x * Chunk.CHUNK_SIDE;
		int chunkZ = chunk.getGridPosition().y * Chunk.CHUNK_SIDE;
		
		if ((z-1 >= 0 && data[x][y][z-1] == 0) || z-1 < 0 && chunkHandler.getBlock(chunkX + x, y, chunkZ + z - 1) == 0) {
		...
		if ((z+1 < Chunk.CHUNK_SIDE && data[x][y][z+1] == 0) || z+1 >= Chunk.CHUNK_SIDE && chunkHandler.getBlock(chunkX + x, y, chunkZ + z + 1) == 0) {
			modelBuilder.normal(-1, 0, 0);
			modelBuilder.uv(texture.getU1(), texture.getV1());
		...
		if ((x-1 >= 0 && data[x-1][y][z] == 0) || x-1 < 0 && chunkHandler.getBlock(chunkX + x - 1, y, chunkZ + z) == 0) {
		...
		if ((x+1 < Chunk.CHUNK_SIDE && data[x+1][y][z] == 0) || x+1 >= Chunk.CHUNK_SIDE && chunkHandler.getBlock(chunkX + x + 1, y, chunkZ + z) == 0) {
			modelBuilder.normal(0, 0, 1);
			modelBuilder.uv(texture.getU1(), texture.getV1());
			modelBuilder.vertex(1 + x, 0 + y, 1 + z);
			modelBuilder.uv(texture.getU2(), texture.getV1());
		...
		if ((y-1 >= 0 && data[x][y-1][z] == 0) || y-1 < 0 && chunkHandler.getBlock(chunkX + x, y - 1, chunkZ + z) == 0) {
		...
		if ((y+1 < Chunk.CHUNK_SIDE && data[x][y+1][z] == 0) || y+1 >= Chunk.CHUNK_SIDE && chunkHandler.getBlock(chunkX + x, y + 1, chunkZ + z) == 0) {
			modelBuilder.normal(0, 1, 0);
